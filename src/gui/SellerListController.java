...
public class SellerListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableView<Seller> tableViewSeller; // Criando as referências para meus objetos

	@FXML
	private TableColumn<Seller, Integer> tableColumnId; // Criando as referências para meus objetos
	...
	public void setSellerService(SellerService service) { // método set para evitar fazer acoplamento forte
